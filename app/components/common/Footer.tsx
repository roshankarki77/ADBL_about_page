...
const Footer = () => {
  return (
    <div className="flex mt-8  justify-center flex-col  flex-wrap lg:flex-row  w-[95%] md:w-[90%] mx-auto">
      <div className="flex flex-col flex-wrap md:justify-center lg:flex-row lg:mr-4 w-full">
        <div className=" flex w-full flex-col md:justify-center md:flex-row">
          <div className="mb-6 lg:mx-9">
            <div className="font-bold text-xl text-green-600 mb-3">
              About Us
            </div>
            <div className="grid grid-cols-2 gap-x-2">
              <div className="text-stone-500 font-medium text-sm mb-2 hoverTextGreenEffect hover:cursor-pointer">
                Introduction
              </div>
              <div className="text-stone-500 font-medium text-sm mb-2 hoverTextGreenEffect hover:cursor-pointer">
              Board of Directors
