        ...
        <div className="intro h-full bg-[url('/introBg.png')] bg-cover bg-[#e8ffdb] lg:bg-cover">
          <div className="introtext w-64 relative left-12 lg: top-10 lg:left-40">
            ...
            <div className="introlinks list-none flex">
              ...
              <li>
                <a href="/team" className="ml-2 text-slate-500">
                  Introduction
                </a>
              </li>
            </div>
          ...
          <div className="flex flex-col pb-8 lg:pb-20 lg:flex-row lg:ml-16 xl:ml-0">
            <div className="flex flex-col text-justify  basis-3/5 max-w-[678px] mx-auto lg:mr-10 lg:mt-10 ">
              ...
              <div className="works  lg:mb-6">
                ...
                establishment, contributing substantial agricultural credit
                supply in the country. Rural finance has been the principal
                operational area of ADBN in the past. However, the bank is also
                involved in commercial banking operations since 1984, to provide
